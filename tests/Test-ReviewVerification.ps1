...
& (Join-Path $root 'scripts\New-AgentTask.ps1') -TaskId $taskId -TaskSelector 'synthetic-review-verification' -Mode manual -RepositoryIds azure-example-app -ConfigPath $testConfigPath | Out-Null

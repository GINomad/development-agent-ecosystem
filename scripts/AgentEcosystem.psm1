...
function Assert-EcosystemConfig {
    ...
    if (-not [bool]$Config.health.automaticRecovery.allowEcosystemSourceChanges -or -not [bool]$Config.health.automaticRecovery.commitVerifiedRepairs -or -not [bool]$Config.health.automaticRecovery.pushVerifiedRepairs) { throw 'Health recovery must permit validated ecosystem-only source changes, repair commits, and exact verified delivery.' }

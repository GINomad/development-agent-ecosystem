...
if ($knowledgeResponsibilities -notmatch 'review guidance' -or $knowledgePrompt -notmatch 'review-derived coding standards' -or $knowledgePrompt -notmatch 'bypassed, deferred, rejected, unresolved' -or $knowledgeSkill -notmatch 'scoped coding standard') { throw 'Knowledge Keeper does not safely curate coding standards from confirmed review guidance.' }
Add-Check -Name 'review-derived-coding-standards' -Detail 'Knowledge Keeper promotes only confirmed, implemented, clean-reviewed and scoped guidance; bypassed or unresolved review items remain excluded'

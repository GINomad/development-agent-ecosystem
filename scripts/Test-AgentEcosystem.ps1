...
Add-Check -Name 'pull-request-lifecycle' -Detail 'Azure array output and incomplete PR objects are normalized safely; active PR waits; completed PR requests Knowledge Keeper closure'

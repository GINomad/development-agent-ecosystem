...
- Run tools as the current signed-in user without the Claude Code permission sandbox. CrowdStrike, AppLocker, WDAC, credentials, repository permissions, and network controls remain authoritative.
